...
invalidQr: 'Ungültiger QR-Code',
  ...
  rsvp: {
    ...
    declineConfirmOwn: 'Wenn du absagst, verlierst du den Zugriff auf diese Veranstaltung. Du kannst danach nur noch eine Rücknahme beantragen.',
    declineConfirmMember: 'Wenn du für %{name} absagst, hat %{name} keinen Zugriff mehr auf diese Veranstaltung.',
    declineConfirmButton: 'Ja, absagen',
  },
  declined: {
    titlePending: 'Du hast abgesagt.',
    titleFinal: 'Deine Einladung wurde abgesagt.',
    subtitlePending: 'Deine Absage wurde übermittelt und wartet auf Bestätigung. Falls du es dir anders überlegst, kannst du jetzt noch eine Rücknahme beantragen.',
    subtitleFinal: 'Deine Absage wurde vom Veranstalter bestätigt. Eine Rücknahme ist nicht mehr möglich.',
    deadline: 'Anmeldefrist: %{date}',
    revokeButton: 'Rücknahme beantragen',
    revocationPending: 'Deine Anfrage zur Rücknahme wird geprüft. Du wirst benachrichtigt sobald sie freigegeben wurde.',
    logout: 'Ausloggen',
  },
  photos: {
