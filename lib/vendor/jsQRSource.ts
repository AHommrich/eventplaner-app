 ...
 *
 * Upstream:   https://github.com/cozmo/jsQR (v1.4.0)
...
/* eslint-disable */
// prettier-ignore
export const JSQR_SOURCE = `(function webpackUniversalModuleDefinition(root, factory) {
...
export const JSQR_VERSION = "1.4.0";
