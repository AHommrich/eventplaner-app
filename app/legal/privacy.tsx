    ...
    <View style={{ flex: 1, backgroundColor: colors.screenBg }}>
      ...
      {loading ? (
        ...
        >
          ...
          {/* Sections render on a card surface: `cardText` is tuned to contrast
              with `card`, not `screenBg` — on light-cardText themes it was
              invisible on the plain screen background. */}
          <View
            style={{
              backgroundColor: colors.card,
